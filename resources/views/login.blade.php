...
<body class="bg-cb1 font-sans">
    ...
    <div class="w-full mx-auto md:w-4/5 lg:2/3">
        ...
        ---------------- Sekce main ----------------
        -->
        <main class="border border-gray-300 md:flex mx-auto items-center justify-center text-ctprim py-12">
            <div class="collapse md:flex md:flex-col md:visible md:bg-[url('/public/img/login-picture.png')] md:bg-contain md:bg-no-repeat md:bg-center md:bg-size-full md:bg-cover md:bg-center md:text-center md:w-1/2 md:justify-center md:items-center md:py-60 md:gap-2">
            ...
            <div class="flex flex-col md:w-1/2">
                ...
                <div class="flex flex-col text-center">
                    ...
                    <form action="#" method="get" class="flex flex-col w-2/3 text-xl gap-2 py-6 mx-auto justify-center text-center">
                        ...
                        <div class="flex gap-6 py-6 justify-center text-xs">
                            <label>
                            ...
                            <div class="flex gap-2">
                                ...
                                <a class="hover:underline hover:cursor-pointer" href="#">Změnit heslo</a>
                            </div>
                        </div>
