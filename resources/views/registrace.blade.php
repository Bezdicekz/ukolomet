    ...
    <header class="flex gap-4 py-2 items-center justify-between px-4 pb-12">
        ...
        <div class="lg:flex hidden gap-4 text-xl">
            ...
            <div x-data="{open: false}" class="relative lg:hidden py-4 px-8">
                ...
                <div class="absolute bg-cb3 opacity-90 top-10 right-5 shadow-lg h-auto w-48 p-4 rounded border border-ctprim space-y-2" x-show="open" @click.away="open = false" x-transition>
                    ...
                    <a href="./login.html"><p class="transition duration-500 ease-in-out p-2 hover:bg-cbtsec rounded-lg font-bold cursor-pointer">Registrace</p></a>
                </div>
            </div>
    </header>
        ...
        <main class="border border-gray-300 md:flex mx-auto items-center justify-center text-ctprim">
            <div class="collapse md:flex md:flex-col md:visible md:bg-[url('/img/login-picture.png')] md:bg-size-full md:bg-cover md:bg-center md:text-center md:w-1/2 md:justify-center md:items-center md:py-60 md:gap-2">
                ...
                <p class="collapse md:visible md:text-xl md:font-bold">Zaregistrujte se.</p>
            </div>
